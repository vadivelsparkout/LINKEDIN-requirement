...
public class link1  {
	...
	void launch() throws IOException, InterruptedException {
		...
		WebElement search= driver.findElement(By.xpath("//button[@type=\"button\"]//li-icon[@type=\"search\"]"));
		...
		//button[@type="button"]//li-icon[@type="search"]
		List<String> nameList = new ArrayList<String>();

		Cell cell1;
		for(int i=0;i<sheet.getLastRowNum();i++) {
			cell1=sheet.getRow(i).getCell(0);
			WebElement search1 = driver.findElement(By.xpath("//li-icon[@type=\"search\"  and @size=\"medium\"] "));
			search1.click();
			Thread.sleep(5000);
			WebElement search2=driver.findElement(By.xpath("//input[@placeholder=\"Search\"]"));
			search2.sendKeys(cell1.getStringCellValue());
			search2.sendKeys(Keys.ENTER);

			Thread.sleep(5000);

			WebElement people = driver.findElement(By.xpath("//*[@id=\"search-reusables__filters-bar\"]/ul/li[2]/button"));
			people.click();
